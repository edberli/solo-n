  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] text-center px-4 space-y-12 animate-fade-in">
      ...
      <div className="w-full max-w-sm space-y-6">
          ...
          <button
              onClick={loginGuest}
              className="w-full flex items-center justify-center gap-4 bg-surface border border-border-color text-primary px-6 py-4 rounded-xl hover:bg-surface-hover transition-all group"
          >
          ...
          {!IS_DEMO_MODE && (
             <div className="relative pt-6">
                <div className="absolute inset-0 flex items-center top-6"><span className="w-full border-t border-border-color"></span></div>
                ...
                <button
                    onClick={login}
                    className="mt-6 w-full flex items-center justify-center gap-3 bg-accent text-bg-dark px-6 py-4 rounded-xl hover:opacity-90 transition-all font-medium tracking-widest uppercase text-sm"
                >
